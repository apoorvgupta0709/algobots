...
# Repository note: two subsystems

This repository hosts the 49-strategy platform above **and** the original
finance-db / FYERS-ingestion + BankNifty pattern subsystem documented below.
They are independent; see each subsystem's own scripts and configs.
